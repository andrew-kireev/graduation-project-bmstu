...
func easyjsonBfe684dbDecode20211NoskoolTeamInternalAppProfilesModels(in *jlexer.Lexer, out *UserProfile) {
...
func easyjsonBfe684dbEncode20211NoskoolTeamInternalAppProfilesModels(out *jwriter.Writer, in UserProfile) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v UserProfile) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBfe684dbEncode20211NoskoolTeamInternalAppProfilesModels(&w, v)
...
func (v *UserProfile) UnmarshalJSON(data []byte) error {
	...
	easyjsonBfe684dbDecode20211NoskoolTeamInternalAppProfilesModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *UserProfile) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBfe684dbDecode20211NoskoolTeamInternalAppProfilesModels(l, v)
}
